...
public class AddCustomer extends JFrame implements ActionListener{
    ...
    tfname.setBounds(180, 80, 150, 25);
    add(tfname);
    ...
    tfnationality.setBounds(180, 130, 150, 25);
    add(tfnationality);
    ...
    tfaadhar.setBounds(180, 180, 150, 25);
    add(tfaadhar);
    ...
    tfaddress.setBounds(180, 230, 150, 25);
    add(tfaddress);
    ...
    rbmale.setBounds(180, 280, 70, 25);
    rbmale.setBackground(Color.WHITE);
    add(rbmale);
    
    rbfemale = new JRadioButton("Female");
    rbfemale.setBounds(260, 280, 90, 25);
    ...
    tfphone.setBounds(180, 330, 150, 25);
    add(tfphone);
    ...
    tfemail.setBounds(180, 380, 150, 25);
    add(tfemail);
    
    JButton save = new JButton("SAVE");
    save.setBackground(Color.BLACK);
    save.setForeground(Color.WHITE);
    save.setBounds(180, 430, 150, 30);
